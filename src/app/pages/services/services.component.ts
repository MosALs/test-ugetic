...
export class ServicesComponent implements OnInit {
  ...
  steps = [
    ...
    { number: 3, title: 'فريق الدعم', description: 'خدمة الدعم الفني مدار الساعة وطوال أيام الأسبوع، عبر نظام الدعم الفني المتقدم المصمم لراحة العملاء او هاتفياً مع أحد من افراد فريق الدعم متوفر باللغتين العربية والانجليزية.' }
  ];
